...
credits:
  ...
  en:
    - "Sound design: Riccardo Moschen"
media:
  cover: { type: image, src: "/projects/data-footprint/data-footprint-cover.jpg" }
  gallery:
...
copy:
  it: |
    ...
    Il sound design, di Riccardo Moschen, evolve insieme all'interazione: ogni movimento della scarpa ridisegna il paesaggio sonoro, in un dialogo continuo tra gesto, immagine e suono. Il tutto sviluppato in TouchDesigner, per gestire l'interazione in tempo reale tra oggetto fisico, sistema visivo e audio. Data Footprint indaga il rapporto tra materiale, tecnologia e percezione: non un semplice oggetto di design, ma un paesaggio da esplorare.
  en: |
